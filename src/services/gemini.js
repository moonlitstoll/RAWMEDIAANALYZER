...
9. **인칭 대명사 간소화**: 인칭 대명사(anh, em, tôi 등)는 '화자보다 어린' 등 장황한 관계 설명을 절대 금지하고 '나', '너', '오빠' 등 1~2글자 단답형으로 적으십시오.
10. **한자어 중복 음 제거**: 한자어 형태소를 분해할 때, 괄호 안에 \`(음: 뜻 음)\` 형태가 아닌 \`(뜻 음)\` 형태로 앞에 중복되는 한자음을 적지 마십시오. 예: \`(심: 마음 심 + 정: 정서 정)\` -> \`(마음 심 + 정서 정)\`
